...
func TestB64Encode(t *testing.T) {
	out, err := execute(t, b64Cmd, []byte{0xd3, 0xb9, 0x89, 0xca, 0x42, 0xfd, 0x34, 0xfa, 0x5a, 0xa7})
	if err != nil {
		t.Fatal(err)
	}
	exp := "07mJykL9NPpapw=="
...
func TestB64Decode(t *testing.T) {
	out, err := execute(t, b64DecCmd, []byte("07mJykL9NPpapw=="))
	if err != nil {
		t.Fatal(err)
	}
...
func TestB64UrlEncode(t *testing.T) {
	out, err := execute(t, b64UrlCmd, []byte{0xf9, 0xf9, 0xf9, 0xf9, 0xf9, 0xf9, 0xf9, 0xf9})
	if err != nil {
		t.Fatal(err)
	}
	exp := "-fn5-fn5-fk="
...
func TestB64UrlDecode(t *testing.T) {
	out, err := execute(t, b64UrlDecCmd, []byte("-fn5-fn5-fk="))
	if err != nil {
		t.Fatal(err)
	}
