...
func TestSHA1(t *testing.T) {
	out, err := execute(t, sha1Cmd, []byte("Hello World!"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestSHA256(t *testing.T) {
	out, err := execute(t, sha256Cmd, []byte("Hello World!"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestSHA384(t *testing.T) {
	out, err := execute(t, sha384Cmd, []byte("Hello World!"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestSHA512(t *testing.T) {
	out, err := execute(t, sha512Cmd, []byte("Hello World!"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestSHAMD5(t *testing.T) {
	out, err := execute(t, md5Cmd, []byte("Hello World!"))
	if err != nil {
		t.Fatal(err)
	}
