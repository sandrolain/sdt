...
var contextTypeList = []ctxDocType{
	...
	{kind: ctxTypeProposal, dir: sdtProposalsDir, tier: ctxTierImportant, scheme: ctxSchemeDated, defaultStatus: ctxWikiStatusDraft, statuses: []string{ctxWikiStatusDraft, ctxReviewVerb, "accepted", "rejected", ctxDocStatusSuperseded}, hasUpdated: true, templateFile: "proposal.md", newSupported: true, pathSupported: true, listSupported: true, templateAllowed: true, statusRow: true},
