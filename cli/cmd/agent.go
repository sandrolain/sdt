...
func agentBlockInstructions(project, group string) string {
	...
	frontmatter += "agent: <agent/tool>     # optional — name of the agent/tool that edited\n"
	frontmatter += "model: <model id>       # optional — model id for provenance\n"
	frontmatter += "session: <session id>   # optional — session id for traceability\n"
